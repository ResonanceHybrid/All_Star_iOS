...
class LightThemeColors {
  //dark swatch
  static const Color primaryColor = Color(0xffFC686F);
  ...
  static const Color scaffoldBackgroundColor = Color(0xFFf5f9fb);
  ...
  //canvas color
  static const Color canvasColor = Color(0xffe1e5ec);
