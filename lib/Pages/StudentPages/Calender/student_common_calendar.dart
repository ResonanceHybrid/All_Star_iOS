...
class StudentCommonCalendarPage extends StatefulWidget {
  const StudentCommonCalendarPage({super.key});

  @override
  State<StudentCommonCalendarPage> createState() =>
      _StudentCommonCalendarPageState();
}

class _StudentCommonCalendarPageState extends State<StudentCommonCalendarPage> {
    ...
    return Row(
      ...
      children: [
        ...
        Container(
          ...
          color:
              eventdata["is_holiday"] == 1 ? AppColors.mainColor : Colors.grey,
        ),
        Expanded(
            flex: 8,
            child: Column(
