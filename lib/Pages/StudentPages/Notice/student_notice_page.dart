...
class StudentNoticePage extends StatefulWidget {
  ...
  const StudentNoticePage({super.key, required this.isFromNotification});
...
class _StudentNoticePageState extends State<StudentNoticePage> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: cm.getAppbarWithDrawerAndAction(context, title: "Notices"),
      body: SafeArea(
        child: Stack(
          children: [
            RefreshIndicator(
                                    ...
                                    children: [
                                      ...
                                      if (e["images"] != null)
                                        if (e["images"]["file_type"] == "pdf")
                                          IconButton(
                                            onPressed: () {
                                              Get.to(() => PdfViewPage(pdfUrl: e["images"]["path"]));
                                            },
    ...
    return showDialog(
      ...
      builder: (_) {
        return Dialog(
          ...
          child: Container(
            padding: const EdgeInsets.all(18).copyWith(bottom: 10.h),
            child: Column(
              ...
              children: [
                ...
                const SizedBox(height: 5),
                SizedBox(
                  height: e["images"] != null ? 450.h : null,
                  child: SingleChildScrollView(
                    child: Column(
                      children: [
                        ...
                        if (e["images"] != null) const SizedBox(height: 10),
                        Html(
                          data: e["description"] ?? "",
                          style: {
                            "body": Style(
