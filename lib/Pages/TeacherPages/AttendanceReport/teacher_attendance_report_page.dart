...
class _AttendanceReportsPageState extends State<AttendanceReportsPage> {
  ...
  Future<void> getAttendanceReport() async {
    ...
    BaseResponse response = await apiMethods.getAttendanceReport(
        widget.selectedType.toString(),
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: cm.getAppBarWithTitle(context, 'Attendance Report'),
      body: Column(
        children: [
          Container(
            ...
            child: Row(
              ...
              children: [
                ...
                Expanded(
                  flex: 3,
                  child: Text(
                    widget.monthList.firstWhere((element) => element.id.toString() == widget.selectedMonth).name,
                    textAlign: TextAlign.center,
                    style: Theme.of(context)
                        .textTheme
                        .titleLarge!
          ...
          Expanded(
            child: isLoading
              ...
              : htmlResponse.isEmpty
                  ? const NoDataWidget()
                  : InAppWebView(
                      initialData: InAppWebViewInitialData(data: htmlResponse),
